# Programa para probar el Ejercicio 2 de la Practica 2
# Grupo 1311
# Javier Delgado del Cerro y Javier Lopez Cano
...
main:
  ...
  # Probamos add y add no efectivos
  add $t3, $t1, $t2 # en r11 un 3 = 1 + 2
